...
$heading = get__post_meta('heading_form');
$subheading = get__post_meta('subheading_form');
$description = get__post_meta('description_form');
...
?>
<section class="form-section form-section-bottom background-accent lg-padding "  id="form">
  <div class="container">
    <div class="row g-4">
      <div class="col-lg-7">
