...
$name = get__post_meta('name');
$position = get__post_meta('position');
...
?>
<section class="form-section background-primary md-padding-top sm-padding-bottom overflow-visible">
