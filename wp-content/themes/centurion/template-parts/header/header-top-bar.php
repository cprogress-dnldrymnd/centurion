...
<div class="top-bar background-black ">
  <div class="container">
    <div class="row row-main justify-content-end justify-content-lg-between">
        ...
        <div class="button-group-box h-100 d-flex justify-content-end">
          ...
          <div class="button-box button-accent h-100 text-end me-0">
            <a href="#" class="h-100 w-100">
              <span class="text d-none d-lg-block">Emergency Contact Form</span>
              <span class="text d-block d-lg-none">Emergency Form</span>
            </a>
          </div>
        </div>
      </div>
